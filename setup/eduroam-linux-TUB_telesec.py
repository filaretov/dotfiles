...
Messages.passwords_difffer = "Die Passwörter stimmen nicht überein"
...
Config.init_confirmation = "Dieses Installationsprogramm funktioniert " \
    "nur für Anwender von {0}."
Config.user_realm = "win.tu-berlin.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius-01.tu-berlin.de', 'DNS:radius-02.tu-berlin.de', 'DNS:radius-03-node1.tubit.tu-berlin.de', 'DNS:radius-03-node2.tubit.tu-berlin.de', 'DNS:radius-03.tu-berlin.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "wlan@win.tu-berlin.de"
