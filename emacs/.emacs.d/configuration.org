...
(use-package change-inner
  :config
  (general-def "C-c i" 'change-inner)
  (general-def "C-c o" 'change-outer))
#+end_src
...
(use-package ryo-modal
  ...
  (general-def "M-j" 'ryo-modal-mode)
  (defun hgf/jump-forward () (interactive) (next-line 15))
  (defun hgf/jump-back () (interactive) (previous-line 15))
  (ryo-modal-keys
   ("." ryo-modal-repeat)
   ("i" ryo-modal-mode)
