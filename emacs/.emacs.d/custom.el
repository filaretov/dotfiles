(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-surround poet-theme comment-dwim-2 rich-minority nova-theme yaml-mode solarized-theme nord-theme htmlize pdf-tools whole-line-or-region markdown-mode magit which-key evil use-package)))
