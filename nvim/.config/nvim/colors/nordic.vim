...
let s:nord0_gui = "#2E3440" " dark0
let s:nord1_gui = "#3B4252" " dark1
let s:nord2_gui = "#434C5E" " dark2
let s:nord3_gui = "#4C566A" " dark3
let s:nord4_gui = "#D8DEE9" " light0
let s:nord5_gui = "#E5E9F0" " light1
let s:nord6_gui = "#ECEFF4" " light2
let s:nord7_gui = "#8FBCBB" " teal
let s:nord8_gui = "#88C0D0" " cyan
let s:nord9_gui = "#81A1C1" " lblue
...
let s:dark0_gui = "#2E3440"
let s:dark1_gui = "#3B4252"
let s:dark2_gui = "#434C5E"
let s:dark3_gui = "#4C566A"
let s:light0_gui = "#D8DEE9"
let s:light1_gui = "#E5E9F0"
let s:light2_gui = "#ECEFF4"
let s:teal_gui = "#8FBCBB"
let s:cyan_gui = "#88C0D0"
let s:lblue_gui = "#81A1C1"
let s:blue_gui = "#5E81AC"
let s:red_gui = "#BF616A"
let s:orange_gui = "#D08770"
let s:yellow_gui = "#EBCB8B"
let s:green_gui = "#A3BE8C"
let s:purple_gui = "#B48EAD"
...
call  s:hi("Type",            s:cyan_gui,         "",      s:nord9_term,   "",      "NONE",                "")
...
call s:hi("pythonDecoratorName", s:orange_gui, "", "", "", "", "")
